...
\begin{frame}
	...
	\begin{proof}
		...
		C &:= \underbrace{\underbrace{\Sigma}_{\forall n \in \N \text{ there is model of size n}} \cup \quad \underbrace{\{\lambda_k \mid k \in \N\}}_{\infty \text{ model}}}_{C \text{ finitely satisfiable } \Rightarrow \text{ } C \text{ satisfiable } \Rightarrow \text{ } C \text{ has an } \infty \text{ model}}
		\end{align*}
	\end{proof}
\end{frame}
...
\section{Another application: Finitary Ramsey Theorem}
